...
#ifndef COMCASTASSIGNMENT_SWIFT_H
#define COMCASTASSIGNMENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ComCastAssignment",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17ComCastAssignment11AppDelegate")
...
SWIFT_CLASS("_TtC17ComCastAssignment13SceneDelegate")
...
SWIFT_CLASS("_TtC17ComCastAssignment14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified btnPlay;
- (void)viewDidLoad;
- (IBAction)btnPressWithSender:(id _Nonnull)sender;
